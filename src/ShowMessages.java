...
/**
 * This class contains the panel where customers & providers can check their inbox.It has a JTable with all their messages & the sender.
 */
public class ShowMessages extends JPanel {
    /**
     * The constructor that creates the panel
     * @param user The user who is checking the inbox
    ...
    public ShowMessages(User user, AccountsCreated listOfAccounts, AccommodationsCreated listOfAccommodations,ReservationsCreated listOfReservations,MainFrame mainFrame){
        ...
        header.setBounds(0,pxCounter,PANEL_WIDTH,50);
