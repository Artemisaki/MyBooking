...
/**
 * This method contains the panel that shows all the accommodations of a provider, all the reserved accommodations and customer's details who reserved the accommodations
 */
public class ProviderAccommodationList extends JPanel {
    ...
    /**
     * @param provider The provider who wants to see/manage personal accommodations
    ...
    /**
     * This method collects new data and updates the JTable whenever the provider change the combo box option from show all my accommodations
     * to show reserved accommodation or to show cancelled reservations and vice versa
     * @param option The option of the combo box
     * @param model The model of he JTable
    ...
    /**
     * This method collects data that are shown in the JTable in the beginning when this panel comes on.
     * @param listOfAccommodations A list with all the accommodations
     * @param provider The provider that is logged in
     * @return The data of the JTable
     */
    ...
    /**
     * This method is called when the provider wants to see all the personal accommodations.It collects all the data
     * like the name,the address,number of rooms,number of reservations etc. and makes a string array that is shown in the JTable
     * @param listOfAccommodations A list with all the accommodations
     * @param provider The provider that is logged in
     * @param model The model of the JTable
     * @return The string array with the data
     */
