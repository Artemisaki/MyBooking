...
public class Date implements Serializable {
    ...
    */
    ...
    /**
     * This method checks if two arriving dates are the same
     * @param date the date that it's going to be checked
     * @return True if they have the same arriving dates else false
     */
